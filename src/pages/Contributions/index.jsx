...
const Contributions = () => {
  ...
  return (
    <div className="">
              ...
              <List.Item>
                ...
                >
                  ...
                  >
                    ...
                    <div className="">
                      <Text className="text-gray-400 font-light font-poppins text-xs">
                  ...
                  <div className="mt-2">
                    ...
                    <Text className="text-gray-400 font-semibold font-poppins text-xs">
                      Posted by :
                    </Text>
                    <div className="flex justify-between items-center">
                      <div className="flex gap-2 mt-1 items-center">
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          <Text className="text-xs text-gray-400 font-light font-poppins">
                            {item.email}
                          </Text>
                        </div>
                      </div>
                      <div className="">
                        {(item.user_id === userID ||
                          ...
                          <div className="flex justify-end relative">
                            <MoreOutlined
                              className="text-xl cursor-pointer hover:text-gray-600 transition"
                              onClick={() =>
                                setDropdownVisible(
                            ...
                            {dropdownVisible === item.id && (
                              <div className="absolute right-0 mt-8 bg-white border rounded-lg shadow-lg z-10 w-[100px]">
                                <button
                                  onClick={() => handleEdit(item)}
                                  className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left transition"
                                >
                                ...
                                <Popconfirm
                                  ...
                                  cancelText="Cancel"
                                >
                                  <button className="block px-4 py-2 text-sm text-gray-700 hover:bg-red-100 w-full text-left transition">
      ...
      <Modal
        title={
          <div className="text-xl font-bold font-poppins text-gray-800">
      ...
      >
        {selectedContent && (
          <div className="p-4">
            {/* Gambar Utama */}
            <div className="h-[350px] rounded-md overflow-hidden shadow-md">
              <img
            ...
            {/* Deskripsi Konten */}
            <div className="mt-6">
              <Text className="text-gray-600 font-light font-poppins text-base leading-relaxed">
            ...
            {/* Informasi Tambahan */}
            <div className="mt-4">
              <Text className="text-gray-500 font-poppins text-sm flex items-center">
              ...
              <div className="flex items-center gap-4 mt-4">
                ...
                />
                <div>
                  <Text className="font-semibold text-gray-800 text-sm font-poppins">
