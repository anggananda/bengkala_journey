    ...
    <div className="p-4 relative">
      <Row gutter={[24, 0]}>
        <Col md={16} lg={16} sm={24} xs={24}>
          <Card className="h-[350px] shadow-lg rounded-2xl bg-gradient-to-r from-blue-500 to-indigo-500 flex flex-col justify-center items-center text-white p-8 transition-transform transform hover:scale-105">
            ...
            <div className="mt-6 flex justify-center items-center space-x-6">
              <Link to="/culture">
                <Button className="bg-white font-poppins text-blue-500 font-semibold rounded-full hover:bg-gray-100 px-8 py-2 transition">
                  Start Exploring
                </Button>
              </Link>
              <Link to="/about">
                <Button className="bg-blue-700 font-poppins text-white font-semibold rounded-full hover:bg-blue-600 px-8 py-2 transition">
                  Learn More
                </Button>
              </Link>
            </div>
          ...
          <div className="my-4">
            <div className="mb-1">
              <Text className="text-lg font-poppins font-semibold text-slate-800 mb-2">
                Tenun Kolok
              </Text>
            </div>
            {tenun.length > 0 && !isLoading ? (
              <div className="flex overflow-x-auto space-x-8 pb-4 custom-scrollbar">
                {tenun.map((item) => (
                  <Card
                    key={item.ID}
                    className="min-w-[220px] md:min-w-[260px] hover:scale-105 transition-all shadow-lg ease-in-out duration-500"
                    cover={
              ...
              <Card className="bg-gray-50 border-none shadow-lg rounded-lg">
                <Chart
                  options={{
                    ...
                    xaxis: {
                      categories: ["Posts", "Forums", "Replies"],
                      labels: {
                        style: {
                          colors: "#6B7280",
                          fontSize: "12px",
                  ...
                  series={[
                    {
                      name: "Contributions",
                      data: [posts, forums, replies], // Replace with dynamic data
                    },
                  ]}
                  type="bar"
                  height={250}
      ...
      <div className="mt-4">
        <Row gutter={[24, 0]}>
          <Col md={24} lg={24} xl={24}>
            <Card className="shadow-md rounded-lg p-6 bg-white">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <Link to="/playlist">
                    <Button
                      type="primary"
                      className="rounded-lg w-[160px] bg-indigo-500 hover:bg-indigo-600 border-none px-4 py-2 font-medium text-white"
                    >
                      See All Videos
                    </Button>
                  </Link>
